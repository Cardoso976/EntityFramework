...
namespace Alura.Loja.Testes.ConsoleApp
{
    internal class ProdutoDAO : IDisposable, IProdutoDAO
    {
        ...
        public ProdutoDAO()
        {
            this.conexao = new SqlConnection("Data Source=DESKTOP-3V5901S\\SQLEXPRESS;Initial Catalog=LojaDB;Integrated Security=False;User ID=admin;Password=1234;Connect Timeout=30;Encrypt=False;TrustServerCertificate=True;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
            this.conexao.Open();
        }
